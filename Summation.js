...
/*
Solution (1) : 
    1) Declare variable contain the summation of the numbers
    2) Loop to get the numbers between 1 to the given number
    3) Return the summation

Solution (2) : 
    1) Use some mathematics to get the number
*/
